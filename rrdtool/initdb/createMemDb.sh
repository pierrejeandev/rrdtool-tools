...
rrdtool create dataMem.rrd --step 60 --start $time \
  DS:memTot:GAUGE:600:U:U DS:memFree:GAUGE:600:U:U \
  DS:memBuf:GAUGE:600:U:U DS:memCache:GAUGE:600:U:U \
  DS:swpTot:GAUGE:600:U:U DS:swpFree:GAUGE:600:U:U \
